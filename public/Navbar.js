  ...
  return(
    <nav className="navbar navbar-expand-lg navbar-dark bg-primary stroke">
      <div className="container-xl">
        <a className="navbar-brand fw-bold"><img className="mr-2" src="./logo.png" alt="Bank logo"/>Mongol Bank</a>
        ...
        <div className="float-end">
          <span className="fw-bold mt-1 text-green" id="loggedInStatus">No User</span>
        </div>
      </div>
    </nav>
  );
